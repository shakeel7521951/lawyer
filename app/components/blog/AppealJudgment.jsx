          ...
          <div className="mt-8 pt-8 border-t border-[#c0b688]/20">
                <div className="grid grid-cols-3 gap-8 text-center">
                  <div>
                   ...
                   <div className="text-sm text-[#494c52]/70" style={{ fontFamily: "'Inter', sans-serif" }}>{t("appeal.experience")}</div>
                  </div>
                 <div>
                   <div className="text-2xl font-bold text-[#c0b688]" style={{ fontFamily: "'Playfair Display', serif" }}>500+</div>
                   <div className="text-sm text-[#494c52]/70" style={{ fontFamily: "'Inter', sans-serif" }}>{t("appeal.won")}</div>
                 </div>                 <div>
                   <div className="text-2xl font-bold text-[#c0b688]" style={{ fontFamily: "'Playfair Display', serif" }}>100%</div>
                   <div className="text-sm text-[#494c52]/70" style={{ fontFamily: "'Inter', sans-serif" }}>{t("appeal.satisfy")}</div>
                  </div>
               </div>
             </div>
        </div>
