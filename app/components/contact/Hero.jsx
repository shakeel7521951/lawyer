      ...
      <section className="relative w-full min-h-screen overflow-hidden">
        ...
        <div className="relative z-10 flex items-center justify-center min-h-screen px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            ...
            {/* Description */}
            <p className="text-lg sm:text-xl leading-relaxed text-white/90 font-light text-center max-w-2xl mx-auto mb-8" style={{ fontFamily: "'Crimson Text', serif", lineHeight: '1.6' }}>
              Our experienced legal team is here to provide you with comprehensive legal solutions. Schedule your consultation today and let us protect your interests.
            </p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 mb-12 max-w-4xl mx-auto">
              <div className="bg-white/10 backdrop-blur-lg rounded-xl p-6 border border-white/20 hover:bg-white/15 transition-all duration-300">
                ...
                <p className="text-white text-sm font-medium mb-1" style={{ fontFamily: "'Inter', sans-serif" }}>Call Us</p>
                <p className="text-[#c0b688] text-lg font-semibold" style={{ fontFamily: "'Inter', sans-serif" }}>+974 6616 4000</p>
              </div>

              <div className="bg-white/10 backdrop-blur-lg rounded-xl p-6 border border-white/20 hover:bg-white/15 transition-all duration-300">
                <Mail className="w-8 h-8 text-[#c0b688] mx-auto mb-3" />
                <p className="text-white text-sm font-medium mb-1" style={{ fontFamily: "'Inter', sans-serif" }}>Email Us</p>
                <p className="text-[#c0b688] text-lg font-semibold" style={{ fontFamily: "'Inter', sans-serif" }}>info@alkhaldi.net</p>
              </div>

              <div className="bg-white/10 backdrop-blur-lg rounded-xl p-6 border border-white/20 hover:bg-white/15 transition-all duration-300">
                <MapPin className="w-8 h-8 text-[#c0b688] mx-auto mb-3" />
                <p className="text-white text-sm font-medium mb-1" style={{ fontFamily: "'Inter', sans-serif" }}>Visit Us</p>
                <p className="text-[#c0b688] text-lg font-semibold" style={{ fontFamily: "'Inter', sans-serif" }}>Al Rayyan, Qatar</p>
              </div>
            </div>
            ...
            <div className="mt-12 bg-white/5 backdrop-blur-sm rounded-xl p-6 border border-white/10 max-w-md mx-auto">
              <div className="flex items-center justify-center mb-4">
                ...
                <h3 className="text-white font-medium" style={{ fontFamily: "'Inter', sans-serif" }}>Business Hours</h3>
              </div>
              <div className="space-y-2 text-sm text-white/80" style={{ fontFamily: "'Inter', sans-serif" }}>
