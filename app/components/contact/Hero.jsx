        ...
        <div className="relative z-10 flex items-center justify-center min-h-screen px-4 sm:px-6 lg:px-8">
          <div className="max-w-4xl mx-auto text-center">
            ...
            >
              <a
                href="#contact-form"
                className="bg-gradient-to-r from-[#9f8660] to-[#c0b688] text-white px-8 py-3 rounded-xl text-sm font-medium transform hover:scale-105 transition-all duration-300 shadow-lg hover:shadow-xl hover:shadow-[#c0b688]/40 flex items-center space-x-2"
            ...
            {/* Business Hours */}
            <div
              className="mt-12 bg-white/5 backdrop-blur-sm rounded-xl p-6 border border-white/10 max-w-md mx-auto hover:shadow-lg hover:shadow-[#c0b688]/10 transition-all duration-300"
              data-aos="fade-up"
              data-aos-delay="300"
            >
