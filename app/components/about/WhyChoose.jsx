...
export default function WhyChooseUs() {
    const { t } = useTranslation("about/whyChoose");
  ...
  const advantages = [
    {
      title: t("about.whyChoose.advantages.0.title"),
      description:
          t("about.whyChoose.advantages.0.description"),
      icon: (
    ...
    {
      title:t("about.whyChoose.advantages.1.title"),
      description:
          t("about.whyChoose.advantages.1.description"),
      icon: (
          <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 20 20">
    ...
    {
      title: t("about.whyChoose.advantages.2.title"),
      description:
        t("about.whyChoose.advantages.2.description"),
      icon: (
          <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 20 20">
    ...
    {
      title: t("about.whyChoose.advantages.3.title"),
      description:
        t("about.whyChoose.advantages.3.description"),
      icon: (
          <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 20 20">
      ...
      <section ref={sectionRef} className="relative w-full bg-gradient-to-br from-gray-50 via-white to-gray-100 py-16 overflow-hidden">
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className={`bg-white rounded-2xl shadow p-8 transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
            <h3 className="text-2xl font-bold text-gray-800 mb-6 text-center">{t("about.whyChoose.commitment.title")}</h3>
            <div className="grid md:grid-cols-3 gap-8 text-center">
              <div>
                ...
                <h4 className="text-lg font-semibold text-gray-800 mb-1">
                  {t("about.whyChoose.commitment.points.0.title")}
                </h4>
                <p className="text-gray-600 text-sm"> {t("about.whyChoose.commitment.points.1.description")}</p>
              </div>
              ...
              <div>
                ...
                <h4 className="text-lg font-semibold text-gray-800 mb-1"> {t("about.whyChoose.commitment.points.1.title")}</h4>
                <p className="text-gray-600 text-sm"> {t("about.whyChoose.commitment.points.1.description")}</p>
              </div>
              ...
              <div>
                ...
                <h4 className="text-lg font-semibold text-gray-800 mb-1"> {t("about.whyChoose.commitment.points.2.title")}</h4>
                <p className="text-gray-600 text-sm"> {t("about.whyChoose.commitment.points.2.description")}</p>
              </div>
            </div>
          </div>
        </div>
