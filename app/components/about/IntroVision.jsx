          ...
          <div className="grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
            ...
            >
              <p className="text-white/90 text-lg mb-6" style={{ fontFamily: "'Inter', sans-serif" }}>
                Our company is dedicated to providing high-quality legal services, building long-term trust with clients and the community. We value excellence, integrity, and partnership in everything we do.
              </p>

              <div className="space-y-4">
                <div className="bg-white/10 backdrop-blur-sm p-5 rounded-2xl border border-[#c0b688]/10">
                  <h4 className="text-[#c0b688] font-semibold mb-1" style={{ fontFamily: "'Playfair Display', serif" }}>
                    Mission
                  </h4>
                  <p className="text-white/80 text-sm" style={{ fontFamily: "'Inter', sans-serif" }}>
                    Deliver professional legal services while protecting client rights and fostering trust.
                  </p>
                </div>
                ...
                <div className="bg-white/10 backdrop-blur-sm p-5 rounded-2xl border border-[#c0b688]/10">
                  ...
                  <p className="text-white/80 text-sm" style={{ fontFamily: "'Inter', sans-serif" }}>
                    To become a leading legal institution locally and internationally through innovation and excellence.
                  </p>
                </div>

                {/* Core Values */}
                <div className="grid grid-cols-3 gap-4 mt-6">
                  {["Excellence", "Trust", "Partnership"].map((val) => (
                      <div
                          key={val}
                          className="text-center p-4 bg-white/5 rounded-xl border border-[#c0b688]/10"
                      >
                        <p className="text-[#c0b688] font-semibold text-sm">{val}</p>
                      </div>
                  ))}
                </div>
              </div>
