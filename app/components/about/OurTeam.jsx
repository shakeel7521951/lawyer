  ...
  return (
    <section className="py-16 px-6 lg:px-20 ">
      <div className="max-w-7xl mx-auto text-center mb-12">
        <h2 className="text-3xl lg:text-4xl font-bold  text-[#9f8660] mb-4">Our Team</h2>
        ...
        {teamMembers.map((member, i) => (
          ...
          >
            ...
            <div className="flex justify-center gap-4  text-lg">
              <a href={member.linkedin} target="_blank" rel="noopener  p-4 hover:border-2 hover:bg-white  noreferrer"><FaLinkedin /></a>
              <a href={member.twitter} target="_blank" rel="noopener   p-4 hover:border-2 hover:bg-white  noreferrer"><FaTwitter /></a>
              <a href={member.instagram} target="_blank" rel="noopener p-4 hover:border-2 hover:bg-white  noreferrer"><FaInstagram /></a>
            </div>
          </div>
        ))}
      </div>
