  ...
  const services = [
    {
      ...
      highlights: t("services.1.highlights"),
    },
    {
      icon: Building2,
      ...
      highlights: t("services.2.highlights"),
    },
    {
      icon: Users,
      ...
      highlights: t("services.3.highlights"),
    },
    {
      icon: Shield,
      ...
      highlights: t("services.4.highlights"),
    },
  ];
      ...
      >
        <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            {/* Main Title */}
            <h2
              className="text-2xl sm:text-3xl lg:text-4xl font-bold mb-4 sm:mb-6 text-[#494c52]"
              ...
              >
                ...
                <div className="flex items-center space-x-4 mb-4">
                  ...
                  <div className="flex-1">
                    <p
                      className="text-[#9f8660] text-xs font-medium uppercase tracking-wide"
                      style={{ fontFamily: "'Inter', sans-serif" }}
                    >
                      {service.subtitle}
                    </p>
                    <h3
                      className="text-lg font-semibold text-[#494c52]"
                      style={{ fontFamily: "'Playfair Display', serif" }}
                    >
                      {service.title}
                    </h3>
                  ...
                  <span
                    className="text-[#494c52]/30 text-2xl font-bold"
                    style={{ fontFamily: "'Inter', sans-serif" }}
                  >
                    0{index + 1}
                  </span>
                ...
                <div className="grid grid-cols-2 gap-2">
                  {Array.isArray(services.highlights) &&
                    services.highlights.slice(0, 4).map((highlight, idx) => (
                        ...
                        <div className="grid lg:grid-cols-2 gap-8 items-center">
                          ...
                          <div className="space-y-6">
                            ...
                            <div className="flex items-center space-x-4">
                              ...
                              <div
                                className="text-[#494c52]/40 text-3xl font-bold"
                                style={{ fontFamily: "'Inter', sans-serif" }}
                              >
                                0{index + 1}
                              </div>
                            ...
                            <div>
                              <p
                                className="text-[#9f8660] text-sm font-medium uppercase tracking-wide mb-2"
                                style={{ fontFamily: "'Inter', sans-serif" }}
                              >
                                {service.subtitle}
                              </p>
                              <h3
                                className="text-2xl lg:text-3xl font-bold text-[#494c52] mb-4"
                                style={{
                          ...
                          <div className="space-y-6">
                            <h4
                              className="text-xl font-semibold text-[#494c52]"
                              style={{
                                fontFamily: "'Playfair Display', serif",
                              }}
                            >
          ...
          >
            <div className="bg-white rounded-xl p-4 sm:p-6 shadow-md border border-gray-100">
              <div
                className="text-2xl sm:text-3xl font-bold text-[#494c52] mb-1"
                style={{ fontFamily: "'Inter', sans-serif" }}
              >
                25+
              </div>
