          ...
          {services.map((service, index) => (
            ...
            >
              ...
              <div className="relative bg-white p-8 h-full">
                ...
                <button className="px-6 py-2 border border-[#0D1B2A] text-[#0D1B2A] font-medium rounded-full group-hover:bg-[#0D1B2A] group-hover:text-white transition-all flex items-center">
                  Learn More
