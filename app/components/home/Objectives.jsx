...
import { Scale, Target, Users, Shield, Award, ChevronRight } from "lucide-react";

const objectives = [
	{
		id: 1,
		title: "Establish Sound Legal Practice",
		description: "We strive to establish an entity rooted in sound legal practice, respecting laws and institutions.",
		icon: Scale,
	},
	{
		id: 2,
		title: "Complete Professional Competence",
		description: "Our professionalism is achieved through complete competence, experience, and unwavering credibility in all legal matters.",
		icon: Target,
	},
	{
		id: 3,
		title: "Engage with Local Community",
		description: "We engage with our local environment by understanding community needs and providing legal assistance to those in need.",
		icon: Users,
	},
	{
		id: 4,
		title: "Expand International Practice",
		description: "We broaden our client base and expand our practice to a wider geographic scope within the international community.",
		icon: Shield,
	},
	{
		id: 5,
		title: "Innovation in Legal Services",
		description: "We embrace new methods that align with technological advancements and current scientific progress.",
		icon: Award,
	},
];
			...
			>
				...
				<div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
					...
					>
						...
						{/* Title */}
						<h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold mb-4 sm:mb-6 text-white" style={{ fontFamily: "'Playfair Display', serif" }}>
							Strategic{" "}
						...
						{/* Description */}
						<p className="text-base sm:text-lg text-white/90 max-w-2xl mx-auto" style={{ fontFamily: "'Inter', sans-serif" }}>
							At{" "}
							<span className="font-semibold text-[#c0b688]">الخالدي Al-Khaldi</span>, our mission is guided by five core objectives that ensure exceptional legal services.
						</p>
					</div>
						...
						{objectives.map((objective, index) => (
							<div
								...
								className={`bg-white/10 backdrop-blur-lg rounded-2xl p-6 border border-white/20 shadow-lg transition-all duration-500 ${
									isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-8"
								} ${index === activeObjective ? "border-[#c0b688]/50 bg-white/15 scale-105" : ""}`}
							...
							{objectives.map((objective, index) => (
								...
								>
									...
									<div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
											...
											>
												...
												<div className="space-y-4">
													<div className="flex items-center space-x-4">
														...
														<div>
															<h3 className="text-xl lg:text-2xl font-bold text-white" style={{ fontFamily: "'Playfair Display', serif" }}>
																{objective.title}
															</h3>
														</div>
													</div>
													...
													{/* Action Button */}
													<button className="inline-flex items-center text-[#c0b688] hover:text-white transition-colors duration-300 text-sm font-medium" style={{ fontFamily: "'Inter', sans-serif" }}>
														Learn More
										...
										<div className={`${index % 2 === 0 ? "lg:order-2" : "lg:order-1"} hidden lg:flex items-center justify-center`}>
					...
					>
						<div className="bg-white/10 backdrop-blur-lg rounded-2xl p-6 sm:p-8 text-white border border-white/20">
							<h3 className="text-xl sm:text-2xl font-bold mb-4" style={{ fontFamily: "'Playfair Display', serif" }}>
								Experience Our Commitment to Excellence
							</h3>
							<p className="text-base sm:text-lg text-white/90 mb-6" style={{ fontFamily: "'Inter', sans-serif" }}>
								Let Al-Khaldi guide you through your legal journey with our proven objectives and unwavering dedication.
							</p>
							<button className="bg-gradient-to-r from-[#c0b688] to-[#9f8660] text-white px-6 py-3 rounded-lg font-medium hover:from-[#9f8660] hover:to-[#494c52] transition-all duration-300 shadow-lg" style={{ fontFamily: "'Inter', sans-serif" }}>
								Get Started Today
							</button>
						</div>
					</div>
