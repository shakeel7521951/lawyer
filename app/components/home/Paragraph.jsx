...
const Paragraph = () => {
  const { t } = useTranslation("home/paragraph");
  ...
  return (
    <>
      ...
      >
              ...
              <div className="space-y-4 sm:space-y-6">
                ...
                <div className="grid grid-cols-3 gap-4 pt-6 mt-6 border-t border-white/20">
                  <div className="text-center">
                    <div
                      className="text-xl sm:text-2xl font-bold text-[#c0b688] mb-1"
                      style={{ fontFamily: "'Inter', sans-serif" }}
                    >
                      19+
                    </div>
                  ...
                  <div className="text-center">
                    <div
                      ...
                      style={{ fontFamily: "'Inter', sans-serif" }}
                    >
                      {t("stats.courts.number")}
                    </div>
                    <div
                      className="text-xs sm:text-sm text-white/70"
                      style={{ fontFamily: "'Inter', sans-serif" }}
                    >
                      {t("stats.courts.label")}
                    </div>
                  </div>
                </div>
              </div>
        ...
        <div
          className={`max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 mt-12 sm:mt-16 pt-8 sm:pt-12 border-t border-white/20 transition-all duration-700 delay-500 ${
