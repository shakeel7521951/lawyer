  ...
  return (
    <div className="w-full min-h-screen bg-white text-gray-800">
      ...
      <div className="bg-[#0D1B2A] text-white py-16 px-4 text-center">
        <h1 className="text-4xl font-bold mb-4">Services for <span className="text-yellow-500">Individual Customers</span></h1>
      ...
      <div className="flex flex-col md:flex-row items-center gap-10 p-6 md:p-12">
        ...
        <div className="md:w-1/2 space-y-4">
          <h2 className="text-2xl font-semibold text-yellow-700">Tailored Banking Solutions</h2>
          <p>
      ...
      <div className="bg-gray-100 py-10 px-4">
        <h2 className="text-3xl font-bold text-center text-yellow-800 mb-8">Our Key Services</h2>
      ...
      <div className="bg-[#0D1B2A] text-white py-12 text-center">
       ...
       <Link href="/contact"> <button className="bg-white cursor-pointer text-yellow-700 px-6 py-2 rounded-md font-semibold hover:bg-gray-100">
          Get Started
        </button></Link>
      </div>
    </div>
